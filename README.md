...
[![License](https://img.shields.io/github/license/fafarabbani/kui-laravel-breeze)](https://github.com/fafarabbani/kui-laravel-breeze/blob/main/LICENSE.md)
[![Releases](https://img.shields.io/github/release/fafarabbani/kui-laravel-breeze)](https://github.com/fafarabbani/kui-laravel-breeze/releases)
[![Stars](https://img.shields.io/github/stars/fafarabbani/kui-laravel-breeze)](https://github.com/fafarabbani/kui-laravel-breeze/stargazers)
[![Total Downloads](https://img.shields.io/packagist/dt/fafarabbani/kui-laravel-breeze.svg)](https://packagist.org/packages/fafarabbani/kui-laravel-breeze)

#### [Jetstream Version](https://github.com/fafarabbani/kui-laravel-jetstream)

<!-- #### [Fortify Version](https://github.com/fafarabbani/kui-laravel-fortify) -->
...
3. Install fafarabbani/kui-laravel-breeze

```sh
composer require fafarabbani/kui-laravel-breeze --dev

# for laravel/breeze < 1.18.0
composer require fafarabbani/kui-laravel-breeze:0.4.0 --dev

# for laravel/breeze < 1.15.0
composer require fafarabbani/kui-laravel-breeze:0.3.0 --dev
...
[![PayPal Me](https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif)](https://saweria.co/podkemonchu/)
